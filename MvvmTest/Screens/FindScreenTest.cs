namespace Inspiring.MvvmTest.Screens {
   ...
   public class FindScreenTest {
      ...
      public void CheckLeafCanFindRoot() {
         ...
         Assert.AreEqual(_shell, _firstInfoScreen.FindScreen<IScreen>("Shell"));
      }

      [TestMethod]
      public void CheckFindParentConductors() {
         Assert.AreEqual(_firstPersonConductor, _firstInfoScreen.FindScreen<IScreen>("Persons"));
         Assert.AreEqual(_secondPersonConductor, _secondInfoScreen.FindScreen<IScreen>("Persons"));
      }

      [TestMethod]
      public void CheckFindAncestorConductor() {
         Assert.AreEqual(_mainConductor, _firstInfoScreen.FindScreen<IScreen>("Main"));
         Assert.AreEqual(_mainConductor, _secondInfoScreen.FindScreen<IScreen>("Main"));
      }

      [TestMethod]
      public void CheckFindRelatedScreen() {
         Assert.AreEqual(_toolboxScreen, _secondInfoScreen.FindScreen<ToolboxScreen>());
         Assert.AreEqual(_toolboxScreen, _secondInfoScreen.FindScreen<IScreen>("Toolbox"));
