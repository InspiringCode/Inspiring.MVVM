namespace Inspiring.Mvvm.ViewModels.Core {
   ...
   public abstract class ViewModelTypeDescriptor : ICustomTypeDescriptor {
      /// <inheritdoc />
   ...
   namespace Contracts {
      [ContractClassFor(typeof(ViewModelTypeDescriptor))]
      internal abstract class ViewModelTypeDescriptorContract : ViewModelTypeDescriptor {
