namespace Inspiring.Mvvm.ViewModels {
   ...
   public static class StandardValidations {
      ...
      //   this Inspiring.Mvvm.ViewModels.Core.CollectionValidatorBuilder<TItemDescriptor, T> builder,
      //   string errorMessage
      ...
      //   this Inspiring.Mvvm.ViewModels.Core.CollectionValidatorBuilder<TItemDescriptor, string> builder,
      //   StringComparison comparisonType,
      //   string errorMessage
      //) where TItemDescriptor : VMDescriptorBase {
