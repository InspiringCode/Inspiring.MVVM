namespace Inspiring.MvvmTest.ApiTests.ViewModels {
   ...
   public class RefreshTests {
      ...
      [TestMethod]
      public void Refresh_OfPropertyWithSource_ReturnsNewSourceValueWhenGetValueIsCalled() {
      ...
      [TestMethod]
      public void Refresh_OfCollectionProperty_DoesNotCallNotifyChange() {

      }


      //[TestMethod]
      //public void Refresh_OfInstanceProperty_CallsNotifyChange() {

      //}

      //[TestMethod]
      //public void Refresh_OfWrapperProperty_CallsNotifyChangeAndGetValueReturnsNewValue() {

      //}

      //[TestMethod]
      //public void Refresh_OfInstanceViewModelProperty_RefreshesChildVMButDoesNotCallNotifyChange() {
   ...
   [TestClass]
   public class RefreshTestsOld : TestBase {
