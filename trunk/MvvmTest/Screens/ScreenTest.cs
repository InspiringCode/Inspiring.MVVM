namespace Inspiring.MvvmTest.Screens {
   ...
   public class ScreenTest {
      ...
      public void TestChildren() {
         var childScreen = new Mock<IScreen>(MockBehavior.Strict);
         ...
         IScreen parentAsScreen = (IScreen)parent.Object;
      ...
      public class ParentScreen : Screen {
         private IScreenFactory<IScreen> _mockFactory;

         public ParentScreen(IScreenFactory<IScreen> mockFactory) {
