namespace Inspiring.Mvvm.ViewModels.Core.BehaviorInterfaces {
   ...
   public interface ICollectionModificationBehavior<TItemVM> : IBehavior where TItemVM : IViewModel {
      /// <summary>
   ...
   namespace Contracts {
      [ContractClassFor(typeof(ICollectionModificationBehavior<>))]
      internal abstract class ICollectionModificationBehaviorContracts<TItemVM> :
         ICollectionModificationBehavior<TItemVM>
