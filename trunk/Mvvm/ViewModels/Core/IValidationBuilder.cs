namespace Inspiring.Mvvm.ViewModels.Core {
   ...
   public interface IValidationBuilder<TVM> : IHideObjectMembers where TVM : ViewModel {
      ...
      void ViewModelValidator(Action<ViewModelValidationArgs> args);
   }
   ...
   public interface ICollectionValidationBuilder<TItemVM, TValue> where TItemVM : ViewModel {
   ...
   public sealed class ValidationEventArgs<TItemVM, TItemValue> where TItemVM : ViewModel {
