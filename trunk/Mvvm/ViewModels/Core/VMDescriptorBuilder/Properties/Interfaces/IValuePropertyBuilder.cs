namespace Inspiring.Mvvm.ViewModels.Core {
   ...
   public interface IValuePropertyBuilder<TSourceObject> {
      ...
      /// </remarks>
      IVMProperty<T> MapsTo<T>(Expression<Func<TSourceObject, T>> sourcePropertySelector);
      ...
      IVMProperty<T> Custom<T>(IValueAccessorBehavior<T> sourceValueAccessor);
   }
}
