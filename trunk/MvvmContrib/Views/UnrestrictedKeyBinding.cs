namespace Inspiring.Mvvm.Views {
   ...
   /// </remarks>
   [TypeConverter(typeof(UnrestrictedKeyBindingConverter)), ValueSerializer(typeof(UnrestrictedKeyBindingValueSerializer))]
   public class UnrestrictedKeyGesture : InputGesture {
      private string _displayString;
      private Key _key;
      private static TypeConverter _keyGestureConverter = new UnrestrictedKeyBindingConverter();
