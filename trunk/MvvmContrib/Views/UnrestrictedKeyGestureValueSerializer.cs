namespace Inspiring.Mvvm.Views {
   ...
   /// </summary>
   public class UnrestrictedKeyBindingValueSerializer : ValueSerializer {
      /// <summary>
      ...
      public override bool CanConvertToString(object value, IValueSerializerContext context) {
         ...
         return (((gesture != null) && ModifierKeysConverter.IsDefinedModifierKeys(gesture.Modifiers)) && UnrestrictedKeyBindingConverter.IsDefinedKey(gesture.Key));
      }
